...
def convert_times(df):
    ...
    df['TimeStamp'] = df['TimeStamp'].dt.tz_localize(pytz.timezone('America/Los_Angeles'),ambiguous='infer')
    df['TimeStamp (ST)'] = df['TimeStamp'].dt.tz_convert(pytz.timezone('Singapore'))
