...
LEARN_FUNC_DICT = {
    "a2c": lambda e: A2C(
        policy="MlpPolicy", learning_rate=1e-3, n_steps=1, gamma=0.7, env=e, seed=0
    ).learn(total_timesteps=10000),
    "acer": lambda e: ACER(
        policy="MlpPolicy", env=e, seed=0, n_steps=1, replay_ratio=1
    ).learn(total_timesteps=15000),
    "acktr": lambda e: ACKTR(
        policy="MlpPolicy", env=e, seed=0, learning_rate=5e-4, n_steps=1
    ...
    "ppo2": lambda e: PPO2(
        policy="MlpPolicy", env=e, seed=0, learning_rate=1.5e-3, lam=0.8
    ).learn(total_timesteps=20000),
    "trpo": lambda e: TRPO(
        policy="MlpPolicy", env=e, seed=0, max_kl=0.05, lam=0.7
    ).learn(total_timesteps=10000),
}
